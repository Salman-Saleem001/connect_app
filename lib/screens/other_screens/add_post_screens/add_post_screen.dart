                ...
                Container(
                  ...
                  child: PrimaryButton(
                    ...
                    onPress: () {
                      ...
                      debugPrint(
                        "setPost===>${File(widget.filePath)}${controller.text}${getController.position?.latitude ?? 0.0}${getController.position?.longitude ?? 0.0},${context.read<GoogleMapScreenProvider>().locationData?.city ?? ''},${context.read<GoogleMapScreenProvider>().locationData?.state ?? ''},${context.read<GoogleMapScreenProvider>().locationData?.country ?? ''}",
                      );
                      getController
                          .setPost(
                        title: '',
